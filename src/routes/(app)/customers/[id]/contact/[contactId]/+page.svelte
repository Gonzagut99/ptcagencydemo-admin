<script>
	...
	const endpointSegments = segments.map((segment, index) => {
...
<div class="flex flex-col font-bold">
	...
	<span>{'Param Id: '}{page.params.id}</span>
	<span
		>{'Param Contact Id: '}{page.params.contactId === undefined
			? 'No definido'
			: page.params.contactId}</span
	>
